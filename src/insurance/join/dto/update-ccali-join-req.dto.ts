...
export class UpdateCcaliJoinReqDto {
  @IsOptional()
  @IsString()
  ...
  @Transform(({ value }) => value?.trim())
  @MaxLength(400)
  @ApiPropertyOptional({ description: '계약자 도로명 주소' })
  phRoadAddr?: string;
  ...
  @Transform(({ value }) => value?.trim())
  @MaxLength(10)
  @ApiPropertyOptional({ description: '계약자 우편번호' })
  phZipCd?: string;
  ...
  @Transform(({ value }) => value?.trim())
  @MaxLength(400)
  @ApiPropertyOptional({ description: '피보험자 도로명 주소' })
  ...
  @Transform(({ value }) => value?.trim())
  @MaxLength(10)
  @ApiPropertyOptional({ description: '피보험자 우편번호' })
  insuredZipCd?: string;
  ...
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '국세청 업종 ID', example: 193 })
  ntsBizTypeId?: number;

  @IsOptional()
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '중대재해 업종 ID', example: 150 })
  ...
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '소속 상시 근로자수' })
  regularEmployeeCnt?: number;

  @IsOptional()
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '파견 근로자수' })
  ...
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '소속 외 하도급 근로자 수' })
  ...
  @IsIn(['Y', 'N'])
  @ApiPropertyOptional({
    description: '중대재해 처벌법에 따른 송치 이력 여부(Y/N)',
  })
  ...
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '보상한도 ID' })
  coverageLimitId?: number;

  @IsOptional()
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '자기부담금' })
  deductibleInsCost?: number;

  @IsOptional()
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '결제 보험료(납입 보험료)' })
  payInsCost?: number;

  @IsOptional()
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '총 보험료' })
  totInsCost?: number;
  ...
  @IsInt()
  @Min(0)
  @ApiPropertyOptional({ description: '보험 갱신 차수(0: 첫가입, 1~n: 차수)' })
  joinRenewNo?: number;
  ...
  @IsInt()
  @IsIn([1, 2, 4])
  @ApiPropertyOptional({ description: '보험료 납부 횟수' })
  instalmentNo?: number;
